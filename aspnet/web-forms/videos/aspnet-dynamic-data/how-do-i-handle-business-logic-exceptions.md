...
---
# <a name="how-do-i-handle-business-logic-exceptions"></a>Comment faire gérer les exceptions de logique métier ?

par [Scott Hanselman](https://github.com/shanselman)

Cette vidéo vous montre comment ajouter une validation au modèle de données. Vous serez en mesure de voir comment cette logique de validation est reflétée dans l’interface utilisateur.

[&#9654;Regarder la vidéo (5 minutes)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/how-do-i-handle-business-logic-exceptions)
