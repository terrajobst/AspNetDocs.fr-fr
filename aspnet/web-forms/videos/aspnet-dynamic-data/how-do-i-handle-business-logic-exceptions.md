...
Cette vidéo vous montre comment ajouter la validation au modèle de données. Vous serez en mesure de voir comment cette logique de validation est indiquée dans l’interface utilisateur.
