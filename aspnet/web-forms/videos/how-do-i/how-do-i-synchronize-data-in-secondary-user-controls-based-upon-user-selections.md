...
---
# <a name="how-do-i-synchronize-data-in-secondary-user-controls-based-upon-user-selections"></a>[Comment] : Synchroniser des données dans un ou plusieurs contrôles utilisateur secondaires en fonction des sélections de l’utilisateur
