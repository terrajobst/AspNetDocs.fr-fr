...
---
# <a name="intro-to-aspnet-for-jsp-developers-welcome-to-aspnet-20"></a>Présentation de ASP.NET pour les développeurs JSP : Bienvenue dans ASP.NET 2,0

par [Microsoft](https://github.com/microsoft)

Cette session se concentre sur l’expérience de base nécessaire pour comprendre ASP.NET et la façon dont ASP.NET s’intègre aux .NET Framework et à Microsoft IIS.
