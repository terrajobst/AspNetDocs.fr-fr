...
description: Cette série de didacticiels montre comment créer une application Web ASP.NET qui utilise SQL Server Compact disponible sur Internet en la déployant sur un site Web de tiers h...
ms.author: riande
ms.date: 11/29/2011
...
> Cette série de didacticiels montre comment créer une application Web ASP.NET qui utilise SQL Server Compact disponible sur Internet en la déployant sur un fournisseur d’hébergement tiers. Requiert Visual Studio 2012 RC ou Visual Studio 2010. Pour plus d’informations à jour sur les fonctionnalités de déploiement, ou pour plus d’informations sur le déploiement d’éditions SQL Server autres que SQL Server Compact, consultez [déploiement Web ASP.net à l’aide de Visual Studio](../../deployment/visual-studio-web-deployment/introduction.md).
