...
> 
> Consultez cette vidéo pour plus d’informations sur cette rubrique : [À l’aide de l’authentification de base formulaires dans ASP.NET](# "using-basic-forms-authentication-in-aspnet").
...
**Figure 11**: Lorsque visite de façon anonyme, un lien de journal s’affiche


![Les utilisateurs authentifiés sont affichés le](an-overview-of-forms-authentication-cs/_static/image28.png)

**Figure 12**: Les utilisateurs authentifiés sont affichés le « Bienvenue ! » Message
...
**Figure 15**: Ce contrôle LoginView affiche « Bienvenue, Jisun. »
