...
ms.locfileid: "78566877"
---
# <a name="recovering-and-changing-passwords-c"></a>Récupération et changement des mots de passe (C#)

par [Scott Mitchell](https://twitter.com/ScottOnWriting)

[Télécharger le code](https://download.microsoft.com/download/6/0/e/60e1bd94-e5f9-4d5a-a079-f23c98f4f67d/CS.13.zip) ou [Télécharger le PDF](https://download.microsoft.com/download/6/0/e/60e1bd94-e5f9-4d5a-a079-f23c98f4f67d/aspnet_tutorial13_ChangingPasswords_cs.pdf)
...
[![RequiresQuestionAndAnswer, EnablePasswordRetrieval et EnablePasswordReset influencent l’apparence et le comportement du contrôle PasswordRecovery](recovering-and-changing-passwords-cs/_static/image2.png)](recovering-and-changing-passwords-cs/_static/image1.png)

**Figure 1**: `RequiresQuestionAndAnswer`, `EnablePasswordRetrieval`et `EnablePasswordReset` influencer l’apparence et le comportement du contrôle PasswordRecovery ([cliquez pour afficher l’image en taille réelle](recovering-and-changing-passwords-cs/_static/image3.png))
...
[![les listes objet, corps et CC ont été mises à jour](recovering-and-changing-passwords-cs/_static/image14.png)](recovering-and-changing-passwords-cs/_static/image13.png)

**Figure 5**: la liste objet, corps et CC a été mise à jour ([cliquez pour afficher l’image en taille réelle](recovering-and-changing-passwords-cs/_static/image15.png))
...
- Un utilisateur verrouillé ne peut pas réinitialiser son mot de passe. Toutefois, un utilisateur non approuvé peut le faire. Nous aborderons les États verrouillés et approuvés plus en détail dans le <a id="_msoanchor_3"> </a>didacticiel sur le [*déverrouillage et l’approbation*](unlocking-and-approving-user-accounts-cs.md) des comptes d’utilisateur.
...
[![un message électronique informe l’utilisateur que son mot de passe a été modifié](recovering-and-changing-passwords-cs/_static/image23.png)](recovering-and-changing-passwords-cs/_static/image22.png)

**Figure 8**: un message électronique informe l’utilisateur que son mot de passe a changé ([cliquez pour afficher l’image en taille réelle](recovering-and-changing-passwords-cs/_static/image24.png))
