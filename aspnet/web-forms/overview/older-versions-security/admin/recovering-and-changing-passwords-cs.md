...
[![TIl RequiresQuestionAndAnswer EnablePasswordRetrieval et EnablePasswordReset influencent le PasswordRecovery apparence du contrôle et le comportement](recovering-and-changing-passwords-cs/_static/image2.png)](recovering-and-changing-passwords-cs/_static/image1.png)
...
[![An Message d’erreur s’affiche si un nom d’utilisateur non valide est entré](recovering-and-changing-passwords-cs/_static/image5.png)](recovering-and-changing-passwords-cs/_static/image4.png)
...
[![An Message d’erreur s’affiche si l’utilisateur entre une réponse non valide de la sécurité](recovering-and-changing-passwords-cs/_static/image8.png)](recovering-and-changing-passwords-cs/_static/image7.png)
...
[![TIl utilisateur reçoit un E-mail avec son nouveau mot de passe](recovering-and-changing-passwords-cs/_static/image11.png)](recovering-and-changing-passwords-cs/_static/image10.png)
...
[![Til sujet, corps et CC liste ont été mis à jour](recovering-and-changing-passwords-cs/_static/image14.png)](recovering-and-changing-passwords-cs/_static/image13.png)

**Figure 5**: L’objet, le corps et le CC liste ont été mis à jour ([cliquez pour afficher l’image en taille réelle](recovering-and-changing-passwords-cs/_static/image15.png))
...
[![Ajj un contrôle ChangePassword à la Page](recovering-and-changing-passwords-cs/_static/image17.png)](recovering-and-changing-passwords-cs/_static/image16.png)
...
[![Ajj un contrôle ChangePassword à la Page](recovering-and-changing-passwords-cs/_static/image20.png)](recovering-and-changing-passwords-cs/_static/image19.png)
...
[![AE-mail n Message informe que l’utilisateur que leur mot de passe a été modifié.](recovering-and-changing-passwords-cs/_static/image23.png)](recovering-and-changing-passwords-cs/_static/image22.png)

**Figure 8**: Un Message de courrier électronique informe que leur mot de passe utilisateur a changé ([cliquez pour afficher l’image en taille réelle](recovering-and-changing-passwords-cs/_static/image24.png))
...
[![AAdministrateur n peut modifier un mot de passe utilisateur](recovering-and-changing-passwords-cs/_static/image26.png)](recovering-and-changing-passwords-cs/_static/image25.png)
