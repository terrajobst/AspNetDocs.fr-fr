...
[![TIl Interface d’insertion de lot](batch-inserting-cs/_static/image2.png)](batch-inserting-cs/_static/image1.png)
...
[![DPlacez un panneau à partir de la boîte à outils vers le concepteur](batch-inserting-cs/_static/image5.png)](batch-inserting-cs/_static/image4.png)
...
[![Dafficher les données retournées à partir de la classe ProductsBLL s GetProducts méthode](batch-inserting-cs/_static/image8.png)](batch-inserting-cs/_static/image7.png)
...
[![Set les listes déroulantes dans la mise à jour, insertion et suppression des onglets à (None)](batch-inserting-cs/_static/image11.png)](batch-inserting-cs/_static/image10.png)
...
[![TIl GridView répertorie les produits et offre le tri et les fonctionnalités de pagination](batch-inserting-cs/_static/image14.png)](batch-inserting-cs/_static/image13.png)
...
[![THE Interface insertion est composé d’une colonne de quatre, Table de sept lignes](batch-inserting-cs/_static/image17.png)](batch-inserting-cs/_static/image16.png)
...
[![Cconfiguration de l’ObjectDataSource d’utiliser la classe SuppliersBLL s GetSuppliers méthode](batch-inserting-cs/_static/image20.png)](batch-inserting-cs/_static/image19.png)
...
[![Dafficher le champ de données CompanyName et SupplierID utilisez comme valeur](batch-inserting-cs/_static/image23.png)](batch-inserting-cs/_static/image22.png)
...
[![TIl ligne d’en-tête contient désormais les fournisseurs et les catégories DropDownList](batch-inserting-cs/_static/image26.png)](batch-inserting-cs/_static/image25.png)
...
[![TIl insertion Interface maintenant inclut des zones de texte pour les noms de produits et les prix](batch-inserting-cs/_static/image29.png)](batch-inserting-cs/_static/image28.png)
...
[![PDentelle StatusLabel contrôle ci-dessus les deux contrôles du panneau](batch-inserting-cs/_static/image32.png)](batch-inserting-cs/_static/image31.png)
...
[![TIl Inserting Interface s’affiche après avoir cliqué sur le bouton de livraison de produit de processus](batch-inserting-cs/_static/image35.png)](batch-inserting-cs/_static/image34.png)
...
[![A Nom de produit est requis lorsque vous entrez vous un prix unitaire](batch-inserting-cs/_static/image38.png)](batch-inserting-cs/_static/image37.png)
...
[![Ttrois nouveaux jardins ont été ajoutées pour le fournisseur Mayumi s](batch-inserting-cs/_static/image41.png)](batch-inserting-cs/_static/image40.png)
...
[![TIl nouveaux produits se trouvent dans la dernière Page du contrôle GridView](batch-inserting-cs/_static/image44.png)](batch-inserting-cs/_static/image43.png)
