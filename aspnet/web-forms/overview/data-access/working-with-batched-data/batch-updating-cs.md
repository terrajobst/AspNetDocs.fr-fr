...
**Figure 8**: Configurer l’ObjectDataSource à utiliser le `CategoriesBLL` clas. ([cliquez pour afficher l’image en taille réelle](batch-updating-cs/_static/image14.png))
