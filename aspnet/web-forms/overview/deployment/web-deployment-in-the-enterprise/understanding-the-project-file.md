...
Pour récupérer une valeur de propriété, utilisez le format *$ (PropertyName)* . Par exemple, pour récupérer la valeur de la **nom_serveur** propriété, vous devez taper :
