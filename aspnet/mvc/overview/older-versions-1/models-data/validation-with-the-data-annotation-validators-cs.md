...
title: Validation avec les validateurs d’annotation deC#données () | Microsoft Docs
author: microsoft
...
**Figure 1**: ajout d’une référence au classeur de modèles d’annotations de données ([cliquez pour afficher l’image en taille réelle](validation-with-the-data-annotation-validators-cs/_static/image3.png))
...
Cette ligne de code inscrit le ataAnnotationsModelBinder comme Binder de modèle par défaut pour l’application ASP.NET MVC entière.
...
**Figure 6**: utilisation de validateurs avec l’Entity Framework ([cliquez pour afficher l’image en taille réelle](validation-with-the-data-annotation-validators-cs/_static/image14.png))
