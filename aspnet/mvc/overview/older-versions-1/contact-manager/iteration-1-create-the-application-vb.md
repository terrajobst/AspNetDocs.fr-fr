...
---
# <a name="iteration-1--create-the-application-vb"></a>#1 d’itération : créer l’application (VB)
...
**Figure 02**: boîte de dialogue créer un projet de test unitaire ([cliquez pour afficher l’image en taille réelle](iteration-1-create-the-application-vb/_static/image4.png))
...
**Figure 03**: fenêtre Explorateur de solutions ([cliquez pour afficher l’image en taille réelle](iteration-1-create-the-application-vb/_static/image6.png))
...
**Figure 05**: concepteur de tables de la base de données ([cliquez pour afficher l’image en taille réelle](iteration-1-create-the-application-vb/_static/image10.png))
...
**Figure 06**: boîte de dialogue Ajouter un nouvel élément ([cliquez pour afficher l’image en taille réelle](iteration-1-create-the-application-vb/_static/image12.png))
...
**Figure 10**: classe contact ([cliquez pour afficher l’image en taille réelle](iteration-1-create-the-application-vb/_static/image20.png))
...
**Figure 11**: ajout du contrôleur de démarrage ([cliquez pour afficher l’image en taille réelle](iteration-1-create-the-application-vb/_static/image22.png))
...
**Figure 12**: ajout de la vue d’index ([cliquez pour afficher l’image en taille réelle](iteration-1-create-the-application-vb/_static/image24.png))

Dans la boîte de dialogue **Ajouter une vue** , activez la case à cocher **créer une vue fortement typée**. Sélectionnez la classe de données d’affichage ContactManager. contact et la liste afficher le contenu. La sélection de ces options génère une vue qui affiche une liste d’enregistrements de contact.
...
**Figure 13**: boîte de dialogue Ajouter une vue ([cliquez pour afficher l’image en taille réelle](iteration-1-create-the-application-vb/_static/image26.png))
...
**Figure 15**: vue d’index ([cliquez pour afficher l’image en taille réelle](iteration-1-create-the-application-vb/_static/image30.png))
...
**Liste 4-Controllers\HomeController.vb (avec les méthodes Create)**
...
**Figure 16**: ajout de la vue Create ([Cliquer pour afficher l’image en taille réelle](iteration-1-create-the-application-vb/_static/image32.png))
...
**Figure 17**: affichage d’une explosion de page ([cliquez pour afficher l’image en taille réelle](iteration-1-create-the-application-vb/_static/image34.png))
...
**Figure 18**: vue Create ([Cliquer pour afficher l’image en taille réelle](iteration-1-create-the-application-vb/_static/image36.png))
...
**Liste 6-Controllers\HomeController.vb (avec les méthodes d’édition)**
...
**Figure 19**: ajout d’une vue de modification ([cliquez pour afficher l’image en taille réelle](iteration-1-create-the-application-vb/_static/image38.png))
...
**Liste 8-Controllers\HomeController.vb (méthodes Delete)**
...
**Figure 20**: vue de confirmation de la suppression ([cliquez pour afficher l’image en plein écran](iteration-1-create-the-application-vb/_static/image40.png))
...
**Figure 21**: vue d’index avec modification du lien ([cliquez pour afficher l’image en taille réelle](iteration-1-create-the-application-vb/_static/image42.png))
...
**Figure 22**: ajout de la vue de confirmation de la suppression ([cliquez pour afficher l’image en taille réelle](iteration-1-create-the-application-vb/_static/image44.png))
...
**Figure 24**: utilisation de la boîte de dialogue Renommer ([cliquez pour afficher l’image en taille réelle](iteration-1-create-the-application-vb/_static/image48.png))
