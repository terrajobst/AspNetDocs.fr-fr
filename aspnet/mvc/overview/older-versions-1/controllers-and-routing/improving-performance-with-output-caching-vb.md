...
Notez que l’attribut &lt;OutputCache&gt; de la liste 4 comprend une propriété Location définie sur la valeur OutputCacheLocation. client. L’attribut &lt;OutputCache&gt; comprend également une propriété NoStore. La propriété NoStore est utilisée pour informer les serveurs proxy et les navigateurs qu’ils ne doivent pas stocker une copie permanente du contenu mis en cache.
