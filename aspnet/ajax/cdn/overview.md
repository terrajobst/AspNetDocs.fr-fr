...
#### <a name="jquery-version-341"></a>version de jQuery 3.4.1
...
Les versions suivantes de [répondre](https://github.com/scottjehl/Respond "répondre") sont hébergés sur le CDN :
