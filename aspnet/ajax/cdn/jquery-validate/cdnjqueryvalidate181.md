...
ms.locfileid: "78585056"
---
# <a name="jqueryvalidate-version-181"></a><span data-ttu-id="ee3ed-102">jquery.validate version 1.8.1</span><span class="sxs-lookup"><span data-stu-id="ee3ed-102">jquery.validate version 1.8.1</span></span>

<span data-ttu-id="ee3ed-103">Les fichiers suivants sont hébergés sur le CDN :</span><span class="sxs-lookup"><span data-stu-id="ee3ed-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="ee3ed-104">Fichiers de localisation au https://ajax.aspnetcdn.com/ajax/jquery.validate/1.8.1/localization/messages\_##.js où # # est le code Loc.</span><span class="sxs-lookup"><span data-stu-id="ee3ed-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.8.1/localization/messages\_##.js where ## is the loc code.</span></span>
