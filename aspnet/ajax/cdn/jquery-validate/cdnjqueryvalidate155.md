...
---
# <a name="jquery-validate-155"></a><span data-ttu-id="fcbfd-102">jQuery Validate 1.5.5</span><span class="sxs-lookup"><span data-stu-id="fcbfd-102">jQuery Validate 1.5.5</span></span>

<span data-ttu-id="fcbfd-103">Les fichiers suivants sont hébergés sur le CDN :</span><span class="sxs-lookup"><span data-stu-id="fcbfd-103">The following files are hosted on the CDN:</span></span>
