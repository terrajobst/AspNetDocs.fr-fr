...
ms.locfileid: "59378314"
---
# <a name="jqueryvalidate-version-18"></a><span data-ttu-id="933d6-102">jquery.validate version 1.8</span><span class="sxs-lookup"><span data-stu-id="933d6-102">jquery.validate version 1.8</span></span>

<span data-ttu-id="933d6-103">Les fichiers suivants sont hébergés sur le CDN :</span><span class="sxs-lookup"><span data-stu-id="933d6-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="933d6-104">Localisation des fichiers au https://ajax.aspnetcdn.com/ajax/jquery.validate/1.8/localization/messages\_##.js où ## est le code de localisation.</span><span class="sxs-lookup"><span data-stu-id="933d6-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.8/localization/messages\_##.js where ## is the loc code.</span></span>
