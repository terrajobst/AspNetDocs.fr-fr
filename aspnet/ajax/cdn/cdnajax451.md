...
ms.locfileid: "78563356"
---
# <a name="aspnet-web-forms-and-ajax-451"></a><span data-ttu-id="8a62b-102">ASP.NET Web Forms et Ajax 4.5.1</span><span class="sxs-lookup"><span data-stu-id="8a62b-102">ASP.NET Web Forms and Ajax 4.5.1</span></span>

<span data-ttu-id="8a62b-103">Les fichiers suivants sont hébergés sur le CDN :</span><span class="sxs-lookup"><span data-stu-id="8a62b-103">The following files are hosted on the CDN:</span></span>
...
<span data-ttu-id="8a62b-104">Remarque : les scripts de globalisation, tels que fr-FR. js, se trouvent dans le dossier suivant :</span><span class="sxs-lookup"><span data-stu-id="8a62b-104">Note: The globalization scripts, such as fr-FR.js, can be found in the following folder:</span></span>
