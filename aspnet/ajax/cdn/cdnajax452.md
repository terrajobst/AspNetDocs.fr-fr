...
ms.locfileid: "59422380"
---
# <a name="aspnet-web-forms-and-ajax-452"></a><span data-ttu-id="91abf-102">ASP.NET Web Forms et Ajax 4.5.2</span><span class="sxs-lookup"><span data-stu-id="91abf-102">ASP.NET Web Forms and Ajax 4.5.2</span></span>

<span data-ttu-id="91abf-103">Les fichiers suivants sont hébergés sur le CDN :</span><span class="sxs-lookup"><span data-stu-id="91abf-103">The following files are hosted on the CDN:</span></span>
...
<span data-ttu-id="91abf-104">Remarque : Vous trouverez les scripts de globalisation, telles que fr-FR.js, dans le dossier suivant :</span><span class="sxs-lookup"><span data-stu-id="91abf-104">Note: The globalization scripts, such as fr-FR.js, can be found in the following folder:</span></span>
