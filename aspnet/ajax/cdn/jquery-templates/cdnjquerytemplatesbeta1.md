...
title: Modèles jQuery bêta 1 | Microsoft Docs
...
ms.locfileid: "78562754"
---
# <a name="jquery-templates-beta-1"></a><span data-ttu-id="db50e-102">jQuery Templates Bêta 1</span><span class="sxs-lookup"><span data-stu-id="db50e-102">jQuery Templates Beta 1</span></span>

<span data-ttu-id="db50e-103">Le plug-in modèles jQuery comprend les fichiers suivants :</span><span class="sxs-lookup"><span data-stu-id="db50e-103">The jQuery Templates plugin includes the following files:</span></span>
