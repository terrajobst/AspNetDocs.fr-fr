...
ms.locfileid: "57027796"
---
<a name="jquery-datatables-192"></a><span data-ttu-id="6a311-102">jQuery DataTables 1.9.2</span><span class="sxs-lookup"><span data-stu-id="6a311-102">jQuery DataTables 1.9.2</span></span>
====================
<span data-ttu-id="6a311-103">Les fichiers suivants pour le plug-ins de DataTables de jQuery sont hébergés sur le CDN :</span><span class="sxs-lookup"><span data-stu-id="6a311-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
