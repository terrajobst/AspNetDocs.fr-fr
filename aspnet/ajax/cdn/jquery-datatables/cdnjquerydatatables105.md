...
ms.locfileid: "57030686"
---
<a name="jquery-datatables-1105"></a><span data-ttu-id="aff8a-102">jQuery DataTables 1.10.5</span><span class="sxs-lookup"><span data-stu-id="aff8a-102">jQuery DataTables 1.10.5</span></span>
====================
<span data-ttu-id="aff8a-103">Les fichiers suivants pour le plug-ins de DataTables de jQuery sont hébergés sur le CDN :</span><span class="sxs-lookup"><span data-stu-id="aff8a-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
