...
ms.locfileid: "78563209"
---
# <a name="jquery-datatables-194"></a><span data-ttu-id="5197b-102">jQuery DataTables 1.9.4</span><span class="sxs-lookup"><span data-stu-id="5197b-102">jQuery DataTables 1.9.4</span></span>

<span data-ttu-id="5197b-103">Les fichiers suivants pour les plug-ins jQuery DataTables sont hébergés sur le CDN :</span><span class="sxs-lookup"><span data-stu-id="5197b-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
