...
ms.locfileid: "59383367"
---
# <a name="jquery-datatables-194"></a><span data-ttu-id="b3c4c-102">jQuery DataTables 1.9.4</span><span class="sxs-lookup"><span data-stu-id="b3c4c-102">jQuery DataTables 1.9.4</span></span>

<span data-ttu-id="b3c4c-103">Les fichiers suivants pour le plug-ins de DataTables de jQuery sont hébergés sur le CDN :</span><span class="sxs-lookup"><span data-stu-id="b3c4c-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
