...
ms.locfileid: "78562705"
---
# <a name="jquery-mobile-141-on-the-microsoft-ajax-cdn"></a><span data-ttu-id="5d4e1-102">jQuery Mobile 1.4.1 sur le CDN Microsoft Ajax</span><span class="sxs-lookup"><span data-stu-id="5d4e1-102">jQuery Mobile 1.4.1 on the Microsoft Ajax CDN</span></span>

<span data-ttu-id="5d4e1-103">La bibliothèque jQuery mobile 1.4.1 comprend les fichiers suivants :</span><span class="sxs-lookup"><span data-stu-id="5d4e1-103">The jQuery Mobile 1.4.1 library includes the following files:</span></span>
