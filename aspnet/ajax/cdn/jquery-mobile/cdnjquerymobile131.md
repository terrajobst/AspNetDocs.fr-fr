...
ms.locfileid: "59395398"
---
# <a name="jquery-mobile-131-on-the-microsoft-ajax-cdn"></a><span data-ttu-id="c603e-102">jQuery Mobile 1.3.1 sur le CDN Microsoft Ajax</span><span class="sxs-lookup"><span data-stu-id="c603e-102">jQuery Mobile 1.3.1 on the Microsoft Ajax CDN</span></span>

<span data-ttu-id="c603e-103">La bibliothèque de Mobile 1.3.1 jQuery inclut les fichiers suivants :</span><span class="sxs-lookup"><span data-stu-id="c603e-103">The jQuery Mobile 1.3.1 library includes the following files:</span></span>
