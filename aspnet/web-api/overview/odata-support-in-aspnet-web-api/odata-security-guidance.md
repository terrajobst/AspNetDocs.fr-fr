...
Cette rubrique décrit certains des problèmes de sécurité dont vous devez tenir compte lors de l’exposition d’un jeu de données via OData pour ASP.NET Web API 2 sur ASP.NET 4.x.
