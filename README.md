...
Ce référentiel contient la documentation conceptuelle ASP.NET 4. x hébergée sur [docs.Microsoft.com/ASPNET](https://docs.microsoft.com/aspnet). Consultez le [Guide de contribution](CONTRIBUTING.md) et la [liste des problèmes](https://github.com/dotnet/AspNetDocs/issues) si vous souhaitez apporter votre aide.
